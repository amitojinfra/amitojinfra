    ...
    try {
      ...
      const calculation = {
        ...
        financial: {
          ...
          netSalaryStatus: netSalary >= 0 ? 'due' : 'overpaid'
        },
  ...
  calculateAttendanceSummary(attendanceRecords, dailyHours) {
    ...
    attendanceRecords.forEach(record => {
      if (record.status === 'Present') {
        ...
        let hoursWorked = dailyHours; // Default to full day
        ...
        // Classify as full or partial day
        ...
        summary.details.push({
          ...
          type: hoursWorked >= dailyHours ? 'full' : 'partial',
