...
class AttendanceService {
  ...
  async markAttendance(attendanceData) {
    try {
      ...
      // Create attendance document with custom ID
      await firestoreService.addDocument(this.collectionName, formattedData);
      
      // Set the document with custom ID (Firestore doesn't allow custom ID in addDocument)
      // We'll use a different approach - store with generated ID but include our custom ID as a field
