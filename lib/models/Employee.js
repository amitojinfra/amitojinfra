...
export const EmployeeSchema = {
  ...
  designation: {
    required: true,
    type: 'string',
    enum: Object.values(EmployeeDesignations)
  },
  aadhar_id: {
    required: false,
    type: 'string',
...
export const validateEmployee = (employeeData) => {
  ...
  if (!employeeData.designation || employeeData.designation.trim() === '') {
    ...
    isValid = false;
  } else if (!Object.values(EmployeeDesignations).includes(employeeData.designation)) {
...
export const generateEmployeeSearchKeywords = (employee) => {
  ...
  if (employee.designation) {
    keywords.push(employee.designation.toLowerCase());
  }
